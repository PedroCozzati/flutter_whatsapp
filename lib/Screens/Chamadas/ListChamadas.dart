...
class _ListChamadasState extends State<ListChamadas> {
  ...
  final List <Profile> perfil = [
    Profile(user: 'João', profileImage: profileImg[0], id: 989, recado: 'recado', lastMessage: 'oi',cel:11973477437),
    Profile(user: 'Maria', profileImage: profileImg[1], id: 98239, recado: 'recado', lastMessage: 'oi',cel:9388383838),
