...
import 'package:flutter_whatsapp/Screens/TelaContaNova/loading.dart';
...
class _TermosState extends State<Termos> {
      ...
      child: Container(
        ...
        child: Column(
              ...
              child: Column(
                children: [
                  Column(
                    ...
                    children: [
                      Padding(
                        padding: const EdgeInsets.only(top:32.0,left: 30,right: 30,bottom: 10),
                        child: Container(
                          width: 400,
                          height: 450,
                          child: ListView(
          ...
          Cookies relacionados a pesquisas
           ...
           O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o whatsapp oferece no site e com caráter enunciativo, mas não limitativo:
           ...
           C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do whatsapp, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.
  ...
  void _confirmarTermos(BuildContext context){
